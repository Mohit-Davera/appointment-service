...
public interface AppointmentRepository extends JpaRepository<Appointment,Integer> {
    ...
    @Query(value = "SELECT a.appointment_id, d.doctor_id as doctorId,d.first_name as firstName, d.last_name as lastName, d.experience as experience, a.speciality as specialist, a.time as bookingTime, a.date as bookingDate, a.status as status FROM appointment a JOIN doctor d ON d.doctor_id=a.doctor_id WHERE a.user_id = :userId"
            ,nativeQuery = true)
    ...
    @Query(value = "SELECT d.doctor_id FROM appointment a JOIN doctor d ON d.doctor_id=a.doctor_id WHERE a.appointment_id = :appointmentId"
            ,nativeQuery = true)
